        ...
        <div class="card-body pt-15">
          ...
          <div v-if="isDetailsOpen" id="kt_comic_user_details">
            <div class="py-5 fs-6">
              ...
              <!--end::Phone-->
              <!--begin::Phone-->
              <div class="fw-bold mt-5">{{ $t("type") }}</div>
              <div class="text-gray-600">{{ dataToShow.type }}</div>
              <!--end::Phone-->
              <!--begin::Phone-->
              <div class="fw-bold mt-5">{{ $t("timeline") }}</div>
              <div class="text-gray-600">{{ dataToShow.timeline }}</div>
              <!--end::Phone-->
              <!--begin::Phone-->
              <div class="fw-bold mt-5">{{ $t("timeline") }}</div>
              <div class="text-gray-600">{{ dataToShow.timeline }}</div>
              <!--end::Phone-->
              <!--begin::Phone-->
              <div class="fw-bold mt-5">{{ $t("currency") }}</div>
              <div class="text-gray-600">{{ dataToShow.currency }}</div>
              <!--end::Phone-->
              <!--begin::Phone-->
              <div class="fw-bold mt-5">{{ $t("invested_before") }}</div>
              <div class="text-gray-600">{{ dataToShow.invested_before }}</div>
              <!--end::Phone-->
              <!--begin::Phone-->
              <div class="fw-bold mt-5">{{ $t("meeting_format") }}</div>
              <div class="text-gray-600">{{ dataToShow.meeting_format }}</div>
              <!--end::Phone-->
              <!--begin::Phone-->
              <div class="fw-bold mt-5">{{ $t("available") }}</div>
              <div class="text-gray-600">{{ dataToShow.available }}</div>
              <!--end::Phone-->
              <!--begin::Phone-->
              <div class="fw-bold mt-5">{{ $t("timezone") }}</div>
              <div class="text-gray-600">{{ dataToShow.timezone }}</div>
              <!--end::Phone-->
              <!--begin::Phone-->
              <div class="fw-bold mt-5">{{ $t("contact_method") }}</div>
              <div class="text-gray-600">{{ dataToShow.contact_method }}</div>
              <!--end::Phone-->

              <!--begin::Interests-->
              <div class="fw-bold mt-5">{{ $t("area") }}</div>
              <div class="flex mt-2 items-center gap-1 flex-wrap">
                <span
                  v-for="(sk, index) in dataToShow.area"
...
const fetchData = async () => {
  try {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_APP_API_URL_NEW}/invests/${route.params.id}`,
      {
        method: "GET",
        headers: {
